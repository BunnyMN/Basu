...
**/dashboard-ын эрх.** Анхны админ secret-ээр: `gh secret set OPS_MEMBERS` →
`нэр@gmail.com:Нэр:admin`, дараа нь redeploy; тэр хүн /dashboard дээр тэр
хаягаараа (Google эсвэл имэйл код) нэвтэрмэгц админ болно. Бусад нь өөрсдөө
нэвтэрч «Эрх хүсэх» дарна, админ «Гишүүд» хуудсанд эрхийг нь сонгоод
зөвшөөрнө, дараа нь эрхийг нь сольж, хааж болно. Имэйлийг нь мэдэж байвал
«Гишүүд» → «Имэйлээр урьдчилан нэмэх». Суудал зөвхөн нотолгоогоор
холбогдоно: админы зөвшөөрөл, эсвэл Google/Apple/имэйл кодоор баталгаажсан
хаяг — дугаар бичсэн төдийгөөр биш.
