  ...
  return {
    ...
    layers: [
      ...
      { id: 'road-label', type: 'symbol', source: 'base', 'source-layer': 'transportation_name',
        ...
        paint: { 'text-color': '#6B665F', 'text-halo-color': '#ffffff', 'text-halo-width': 1.5 } },
